...
export class SeedPredefineData1726026802492 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
      ...
      VALUES 
      ('ConfigPath', 'LOG', 'Log path', './logs', './logs', 'Y', NULL, '2567-09-24 07:50:08.237', NULL, '2567-09-24 07:50:08.237'),
      ('Is_Active', 'N', '', 'Inactive', 'ไม่ใช้งาน', 'Y', NULL, '2567-09-13 05:45:44.687', NULL, '2567-09-13 05:45:44.687'),
