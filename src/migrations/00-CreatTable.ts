...
export class CreatTable implements MigrationInterface {
  name = '00-CreatTable';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "um_Role_Permission" ("Role_ID" int NOT NULL, "Menu_No" nvarchar(5) NOT NULL, "Can_Add" nvarchar(1) NOT NULL, "Can_Update" nvarchar(1) NOT NULL, "Can_View" nvarchar(1) NOT NULL, "Is_Active" nvarchar(1) NOT NULL, "Create_By" int NOT NULL, "Create_Date" datetime NOT NULL, "Update_By" int NOT NULL, "Update_Date" datetime NOT NULL, CONSTRAINT "PK_6fa1309576015e689a732fe4e3c" PRIMARY KEY ("Role_ID", "Menu_No"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "um_Role" ("Role_ID" int NOT NULL IDENTITY(1,1), "Role_Name_TH" nvarchar(200) NOT NULL, "Role_Name_EN" nvarchar(200) NOT NULL, "Is_Active" nvarchar(1) NOT NULL, "Create_By" int NOT NULL, "Create_Date" datetime NOT NULL CONSTRAINT "DF_ebe9117d50768e5174f5799ba10" DEFAULT getdate(), "Update_By" int NOT NULL, "Update_Date" datetime NOT NULL CONSTRAINT "DF_3e3b33db8c4d8132114f804fe8d" DEFAULT getdate(), CONSTRAINT "PK_669a023ede661f5c1142ba5a808" PRIMARY KEY ("Role_ID"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "co_Predefine" ("Predefine_Group" nvarchar(20) NOT NULL, "Predefine_CD" nvarchar(20) NOT NULL, "Description" nvarchar(600) NOT NULL, "Value_TH" nvarchar(600) NOT NULL, "Value_EN" nvarchar(600) NOT NULL, "Is_Active" nvarchar(1) NOT NULL, "Create_By" int NOT NULL, "Create_Date" datetime NOT NULL CONSTRAINT "DF_aff4c2aa8b674a36dc3e3424e11" DEFAULT getdate(), "Update_By" int NOT NULL, "Update_Date" datetime NOT NULL CONSTRAINT "DF_2109bd1ca4b91266be0e5ff099c" DEFAULT getdate(), CONSTRAINT "PK_f8b4d91453b1a244a7fa6cdd6c9" PRIMARY KEY ("Predefine_Group", "Predefine_CD"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "um_Menu" ("Menu_No" nvarchar(10) NOT NULL, "Menu_Name_TH" nvarchar(255) NOT NULL, "Menu_Name_EN" nvarchar(255) NOT NULL, "URL" nvarchar(255) NOT NULL, "Menu_Group" nvarchar(10) NOT NULL, "Menu_Icon" nvarchar(255) NOT NULL, "Is_MainMenu" nvarchar(1) NOT NULL, "Is_Active" nvarchar(1) NOT NULL, "Menu_Seq" int NOT NULL, "Created_By" int NOT NULL, "Created_Date" datetime NOT NULL CONSTRAINT "DF_f34099886409e6ba7d2dbc33519" DEFAULT getdate(), "Updated_by" int NOT NULL, "Updated_Date" datetime NOT NULL CONSTRAINT "DF_13b853b50017a2027f49340f918" DEFAULT getdate(), CONSTRAINT "PK_43d3bf898226cd35b6af190c18b" PRIMARY KEY ("Menu_No"))`,
    );
    await queryRunner.query(
